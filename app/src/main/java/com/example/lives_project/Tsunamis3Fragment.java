...
public class Tsunamis3Fragment extends Fragment {

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
      View view =  inflater.inflate(R.layout.fragment_tsunamis3, container, false);
    ...
    public void onPageTurner1BtnClick() {
        ...
        fragmentTransaction.replace(R.id.lessons_fragment2_container, new Tsunamis4Fragment());
